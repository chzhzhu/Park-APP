package com.oracle.hackson.webapp.kafka.connect.mongodb;
...
import com.oracle.hackson.webapp.kafka.connect.utils.LogUtils;
import com.oracle.hackson.webapp.kafka.connect.utils.StringUtils;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.util.*;

import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.PORT;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.HOST;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.URI;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.SCHEMA_NAME;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.BATCH_SIZE;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.TOPIC_PREFIX;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.CONVERTER_CLASS;
import static com.oracle.hackson.webapp.kafka.connect.mongodb.MongodbSourceConfig.DATABASES;
